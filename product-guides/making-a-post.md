...
Για να τροποποιήσετε τη _**Διεύθυνση Χρέωσης**_** ** (λάβετε υπόψη πως η ενημέρωση της διεύθυνσης ενδέχεται να επηρεάσει τις φορολογικές πολιτικές), κλικάρετε το εικονίδιο επεξεργασίας δεξιά. Συμπληρώστε τη **Διεύθυνση 1** (υποχρεωτικά), τη **Διεύθυνση 2**, την **Πόλη** (υποχρεωτικά), τη **Χώρα**, τον **Ταχυδρομικό Κώδικα** (υποχρεωτικά) και την **Περιφερειακή Ενότητα**. Για να αποσταλεί η παραγγελία στην ίδια διεύθυνση, θα πρέπει να ενεργοποιήστε (<Ναι>) την επιλογή **<Αποστολή στην ίδια διεύθυνση;>**, και η διεύθυνση αποστολής θα συμπληρωθεί αυτόματα.
