...
Ακόμη, για να ακυρώσετε μεμονωμένα ή μαζικά παραγγελίες, επιλέξτε εκείνες που θέλετε από το κουτάκι στα αριστερά τους και έπειτα πατήστε το κόκκινο κουμπί <mark style="color:red;"><Ακύρωση Παραγγελίας></mark>.
