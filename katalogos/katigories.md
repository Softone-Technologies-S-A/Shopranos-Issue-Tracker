...
2. Στην καρτέλα **<Περιεχόμενο>**, μπορείτε να προσθέσετε επιπλέον οπτικό υλικό και πληροφορίες αναφορικά με την κατηγορία (<mark style="color:blue;"><+ Προσθήκη πρόσθετου περιεχομένου></mark>), επιλέγοντας και πάλι την επιθυμητή γλώσσα για τον Τίτλο και την Περιγραφή. Μόλις ολοκληρώσετε την εργασία σας, πατήστε <mark style="color:blue;"><ΟΚ></mark> και έπειτα <mark style="color:blue;"><Αποθήκευση></mark> για να εμφανιστούν οι αλλαγές στον ιστότοπό σας.
...
<figure><img src="../.gitbook/assets/ScreenHunter 48 (1).png" alt=""><figcaption><p>Εικόνα 5: Καρτέλα &#x3C;SEO></p></figcaption></figure>
