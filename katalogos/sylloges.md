...
<figure><img src="../.gitbook/assets/ScreenHunter 298.png" alt=""><figcaption></figcaption></figure>
...
{% hint style="info" %}
Έχετε τη δυνατότητα να ορίσετε **τίτλο SEO, Περιγραφή SEO και Meta Tag λέξεις-κλειδιά** με τη βοήθεια του _Al Assistant_ (Τεχνητή Νοημοσύνη).&#x20;
