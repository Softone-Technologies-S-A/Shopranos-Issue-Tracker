...
Στην καρτέλα _<Περισσότερα πλάνα>_ επιλέγετε Πρόγραμμα συνδρομής από τα προτεινόμενα: Start (ιδανικό για εκκίνηση), Basic (ιδανικό για βασικό customization, Standard (προσφέρει ένα βασικό πακέτο δυνατοτήτων), Premium (παρέχει πλούσια γκάμα δυνατοτήτων) και Enterprise (για μέγιστες δυνατότητες).&#x20;
