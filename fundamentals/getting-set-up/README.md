...
Στην πρώτη περίπτωση (βλ. Εικόνα 6), εμφανίζεται ένα νέο παράθυρο, όπου καλείστε να επιλέξετε ανάμεσα σε Skip και OverWrite (Τρόπος) και να ορίσετε τη γλώσσα στην οποία θα δημιουργηθούν τα πεδία. Πατώντας το κουμπί <Αποστολή> θα παραχθεί περιεχόμενο για τα προϊόντα με βάση τα φίλτρα που έχετε εφαρμόσει.&#x20;
