...
<figure><img src="../../.gitbook/assets/ScreenHunter 938.png" alt=""><figcaption><p>Εικόνα 6</p></figcaption></figure>
...
Πάνω δεξιά, πατώντας <Επεξεργασία> (βλ. Εικόνα 9α & 9β) μεταβαίνετε σε ένα νέο παράθυρο, όπου μπορείτε να τροποποιήσετε τα πεδία του προϊόντος.&#x20;
