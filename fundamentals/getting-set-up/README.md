...
Στη συνέχεια, θα μεταφερθείτε στη _φόρμα μαζικής ενημέρωσης_ (βλ. Εικόνες 5,6,7), όπου:
...
| **<Πρόσθετες κατηγορίες>**    | Προσθέτετε επιπλέον κατηγορίες στις οποίες θα εμφανίζεται το προϊόν στο e-shop.                                                     |
...
| **<Πρότυπα χαρακτηριστικών>** | Επιλέγετε ένα πρότυπο χαρακτηριστικών για να προσθέσετε χαρακτηριστικά στο προϊόν.                                                  |
