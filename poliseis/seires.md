...
Αναζητήστε από την αντίστοιχη μπάρα (Όλα, Αρχειοθετημένο, Σε Προσχέδιο, Ενεργό) σειρές παραγγελιών σε Advanced Search, επιλέγοντας Τύπο σειράς: Παραγγελία ή Επιστροφή. Πατήστε <Καθαρισμός Φίλτρων> για να εφαρμόσετε φίλτρα εκ νέου.&#x20;
