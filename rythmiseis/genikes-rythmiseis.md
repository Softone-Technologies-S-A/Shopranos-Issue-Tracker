...
6. **<Γλώσσες>** (βλ. Εικόνα 7), καλείστε να ορίσετε τις γλώσσες στις οποίες θα είναι διαθέσιμη η ιστοσελίδα. Διαλέξτε Προεπιλεγμένη Γλώσσα και ενεργοποιείστε ακριβώς από κάτω τις γλώσσες που επιθυμείτε. Για να επαναφέρετε τις ρυθμίσεις, πατήστε το κουμπί <Επαναφορά>.
