...
2. Στην καρτέλα **<Πελάτες>,** αναφορικά με τον **τρόπο εισαγωγής** πελατών, μπορείτε να επιλέξετε ανάμεσα στα: _Να μην γίνεται εισαγωγή, Να γίνεται εισαγωγή, Εισαγάγετε και ενημερώστε._
