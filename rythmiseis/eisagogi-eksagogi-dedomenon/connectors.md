...
* Για την **παρακολούθηση αναμενόμενων** επιλέγετε ανάμεσα στα: _Καμία παρακολούθηση, Παρακολούθηση μεταγενέστερων και Όλα._
* Για την **παρακολούθηση αποθήκης**, επιλέγετε ανάμεσα στα: _Λογιστικό υπόλοιπο, Πλασματικό υπόλοιπο και Accounting Reserved._
