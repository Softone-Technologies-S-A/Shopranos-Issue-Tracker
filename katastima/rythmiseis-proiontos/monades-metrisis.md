...
Θα δείτε στη _Λίστα μονάδων_ (Αλφαβητικά Α-Ω, Αλφαβητικά Ω-Α, Νεότερο σε παλαιότερο, Παλαιότερο σε νεότερο): τα Ονόματα της κάθε μονάδας, την Τελευταία Αλλαγή, ενώ μπορείτε να επιλέξετε την Εμφάνιση ενεργειών (Ενέργειες > Εμφάνιση) ή τη Διαγραφή της μονάδας (Ενέργειες > Διαγραφή).
