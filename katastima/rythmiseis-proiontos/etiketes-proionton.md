...
* Ορίστε τη Μέθοδο ανάθεσης προϊόντων, ανάμεσα σε: _Χειροκίνητα_ (μη αυτόματα) ή _Αυτόματα_. Προσθέστε **Συνθήκη** πληκτρολογώντας ένα όνομα ή επιλέγοντας από τη λίστα προϊόν.
