...
Στα _αποτελέσματα αναζήτησης_ θα εμφανιστούν: οι _Ομάδες Πελατών_, η _Κατάσταση_, η _Ημερομηνία εισαγωγής_, ενώ μπορείτε να επιλέξετε την εμφάνιση ενεργειών ή τη διαγραφή της ομάδας πελατών (Ενέργειες > Εμφάνιση ή Διαγραφή, αντίστοιχα).
