...
Επιλέγοντας **Ενέργειες > Εμφάνιση** πελάτη ή κλικάροντας επάνω στο όνομά του,μπορείτε να δείτε επιπλέον την Κατάσταση και το Υπόλοιπο. Δεξιά, θα δείτε τις _καρτέλες_ (βλ. Καρτέλες 1-6) __ με όλα τα δεδομένα που αφορούν τον πελάτη.&#x20;
