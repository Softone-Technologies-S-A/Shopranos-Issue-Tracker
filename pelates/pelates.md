...
Έχετε τη δυνατότητα να διαγράψετε από τη λίστα πελάτες, πατώντας μέσα στο κουτάκι αριστερά από το κάθε αντικείμενο ή το πρώτο κουτάκι της στήλης για επιλογή όλων και έπειτα <mark style="color:red;"><Διαγραφή Επιλεγμένων></mark> στα δεξιά (βλ. Εικόνα 2).

<figure><img src="../.gitbook/assets/ScreenHunter 528.png" alt=""><figcaption><p>Εικόνα 2</p></figcaption></figure>
