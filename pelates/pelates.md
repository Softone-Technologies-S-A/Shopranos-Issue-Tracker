...
* Για να προσθέσετε πελάτη, επιλέξτε το κουμπί <mark style="color:blue;"><Νέο></mark> πάνω δεξιά. Θα μεταφερθείτε στις _καρτέλες_ με όλα τα δεδομένα που σχετίζονται με τον πελάτη. Αριστερά, μπορείτε να ορίσετε την κατάσταση του πελάτη, καθώς και να δείτε το υπόλοιπο που αντιστοιχεί (Χρέωση, Πίστωση και Balance).&#x20;

1. Στην καρτέλα **\<Dashboard>** (βλ. Εικόνα 6): εμφανίζονται τα στατιστικά που θα αντιστοιχούν στον πελάτη.
