...
* **Προσθήκη > Λίστα φίλτρων (βλ. Εικόνα 2).**  Στην περίπτωση αυτή, καλείστε να επιλέξετε  υποχρεωτικά Προκαθορισμένη <Εμφάνιση>, καθώς και να ορίσετε <Όνομα δομικού στοιχείου> και <Σειρά ταξινόμησης> (Newest to oldest, Oldest to newest, Αλφαβητικά Α-Ω, Αλφαβητικά Ω-Α, Χαμηλότερη σε υψηλότερη τιμή ή Υψηλότερη σε χαμηλότερη τιμή).
...
<figure><img src="../../.gitbook/assets/ScreenHunter 239.png" alt=""><figcaption></figcaption></figure>
